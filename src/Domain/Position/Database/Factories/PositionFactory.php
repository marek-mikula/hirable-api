...
class PositionFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'hard_skills' => null,
            'organisation_skills' => fake()->numberBetween(0, 100),
            'team_skills' => fake()->numberBetween(0, 100),
            'time_management' => fake()->numberBetween(0, 100),
            'communication_skills' => fake()->numberBetween(0, 100),
            'leadership' => fake()->numberBetween(0, 100),
            'language_requirements' => [],
            'note' => fake()->boolean ? fake()->text(2000) : null,
            'hard_skills_weight' => fake()->numberBetween(0, 100),
            'soft_skills_weight' => fake()->numberBetween(0, 100),
            'language_skills_weight' => fake()->numberBetween(0, 100),
            'experience_weight' => fake()->numberBetween(0, 100),
