...
use Domain\Position\Mail\PositionCandidateEvaluationRequestedMail;
use Domain\Position\Models\PositionCandidateEvaluation;
use Domain\User\Models\User;
use Illuminate\Queue\Attributes\WithoutRelations;

class PositionCandidateEvaluationRequestedNotification extends QueueNotification
{
    public NotificationTypeEnum $type = NotificationTypeEnum::POSITION_CANDIDATE_EVALUATION_REQUESTED;
    ...
    public function toMail(User $notifiable): PositionCandidateEvaluationRequestedMail
    {
        return new PositionCandidateEvaluationRequestedMail(
