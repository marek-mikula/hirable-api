...
class PositionCandidateActionUpdateRequest extends PositionCandidateActionStoreRequest
{
    ...
    public function rules(): array
    {
        ...
        $actionFields = match ($positionCandidateAction->type) {
            ...
            ActionTypeEnum::TEST => [
                ...
                'evaluation' => [
                    Rule::requiredIf($operation === ActionOperationEnum::FINISH || $positionCandidateAction->state === ActionStateEnum::FINISHED),
                    'nullable',
                    'string',
                    'max:500',
                ],
    ...
    public function toData(): ActionData
    {
        ...
        return match ($positionCandidateAction->type) {
            ActionTypeEnum::INTERVIEW => new ActionData(
                type: $positionCandidateAction->type,
                operation: $operation,
