...
class PositionCandidateActionResource extends Resource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'interviewResult' => $this->resource->interview_result,
            'assessmentCenterResult' => $this->resource->assessment_center_result,
            ...
            'taskType' => $this->resource->task_type ? new ClassifierResource($toClassifier->handle($this->resource->task_type, ClassifierTypeEnum::TASK_TYPE)) : null,
            'taskResult' => $this->resource->task_result,
