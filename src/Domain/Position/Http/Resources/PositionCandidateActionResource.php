...
class PositionCandidateActionResource extends Resource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'date' => $this->resource->date?->$this->toIso8601String(),
            'timeStart' => $this->resource->time_start?->$this->toIso8601String(),
            'timeEnd' => $this->resource->time_end?->$this->toIso8601String(),
