...
class PositionMapper extends ModelMapper
{
    ...
    public function mapField(Model $model, string $field): mixed
    {
        ...
        return match ($field) {
            ...
            PositionFieldEnum::WORKLOADS => array_map(fn (string $value) => $this->classifierTranslateService->translateValue(ClassifierTypeEnum::WORKLOAD, $value, LanguageEnum::EN->value), $model->workloads),
            PositionFieldEnum::EMPLOYMENT_RELATIONSHIPS => array_map(fn (string $value) => $this->classifierTranslateService->translateValue(ClassifierTypeEnum::EMPLOYMENT_RELATIONSHIP, $value, LanguageEnum::EN->value), $model->employment_relationships),
            PositionFieldEnum::EMPLOYMENT_FORMS => array_map(fn (string $value) => $this->classifierTranslateService->translateValue(ClassifierTypeEnum::EMPLOYMENT_FORM, $value, LanguageEnum::EN->value), $model->employment_forms),
            ...
            PositionFieldEnum::BENEFITS => array_map(fn (string $value) => $this->classifierTranslateService->translateValue(ClassifierTypeEnum::BENEFIT, $value, LanguageEnum::EN->value), $model->benefits),
            ...
            PositionFieldEnum::SENIORITY => array_map(fn (string $value) => $this->classifierTranslateService->translateValue(ClassifierTypeEnum::SENIORITY, $value, LanguageEnum::EN->value), $model->seniority),
